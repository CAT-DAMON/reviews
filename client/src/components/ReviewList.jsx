...
class ReviewList extends React.Component {
  ...
  getItemReviews(sort) {
    $.get(`http://localhost:3001/api-items/${this.state.storeId}/${this.state.id}/${this.state.sort}`)
      .done((reviews) => {
        console.log(reviews)
  ...
  getShopReviews(sort) {
    $.get(`http://localhost:3001/api-store/${this.state.storeId}/${this.state.sort}`)
      .done((reviews) => {
